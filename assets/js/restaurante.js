...
if ('geolocation' in navigator) {
  ...
  // API HOSPEDAGEM
    ...
    const hospedagem_api = `https://api.geoapify.com/v2/places?categories=catering&conditions=wheelchair.yes&filter=circle:${lon},${lat},100000&bias=proximity:${lon},${lat}&limit=100&apiKey=${key_api}`;
